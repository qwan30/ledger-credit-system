...
description: Upgrade a raw prompt into an execution-ready instruction set for Codex or another AI agent. Use when the user wants to improve an existing prompt, build a reusable prompting framework, wrap the current request with better structure, or add clearer tool and verification rules.
---

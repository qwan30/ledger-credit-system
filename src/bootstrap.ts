...
export async function applyAppSetup(app: NestFastifyApplication): Promise<void> {
  ...
  app.getHttpAdapter().getInstance().addHook("onRequest", async (request: FastifyRequest, reply: FastifyReply) => {
